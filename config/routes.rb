MinyanMate::Application.routes.draw do
  ...
  # in the HTML and dynamically change which event it is for with JS.
  # This messes up statically setting the form up if we included the
  # minyan and event_id in the route.
